...
export const SystemPrompt: FC<Props> = ({
  ...
  return (
    <div className="flex flex-col">
      ...
      <textarea
        ref={textareaRef}
        className="w-full rounded-lg border border-neutral-200 bg-transparent px-4 py-3 text-neutral-900 dark:border-neutral-600 dark:text-neutral-100 bg-pga-dark"
        style={{
          resize: 'none',
