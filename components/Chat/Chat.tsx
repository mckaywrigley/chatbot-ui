import { IconCapture, IconClearAll, IconSettings, IconPdf } from '@tabler/icons-react';
import {
  MutableRefObject,
  memo,
  useCallback,
  ...
  const generatePdfHandler = async () => {
    ...
    try {
      ...
      const pdf = new jsPDF({
        orientation,
        unit: 'pt',
        format: [canvas.width / pixelRatio, canvas.height / pixelRatio],
      });
      ...
      toast.error(t<string>('An error occurred while generating the PDF'));
    }
  };
