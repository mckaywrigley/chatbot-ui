...
export const ChatInput = ({
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full border-transparent pt-6 dark:border-white/20 md:pt-2 bg-gradient-to-b from-transparent dark:to-gray-800 to-white">
      <div className="stretch mx-2 mt-4 flex flex-row gap-3 last:mb-2 md:mx-4 md:mt-[52px] md:last:mb-6 lg:mx-auto lg:max-w-3xl">
        ...
        <div className="relative mx-2 flex w-full items-center justify-between flex-grow flex-col rounded-md border border-black/10 bg-white shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:border-gray-900/50 dark:bg-gray-700 dark:text-white dark:shadow-[0_0_15px_rgba(0,0,0,0.10)] sm:mx-4">
          <textarea
            ref={textareaRef}
            className="m-0 rounded-md w-full resize-none border-0 bg-transparent p-0 py-2 px-4 text-black dark:bg-transparent dark:text-white"
            style={{
              resize: 'none',
          ...
          {showScrollDownButton && (
            <div className="absolute bottom-12 right-0 lg:bottom-0 lg:-right-10">
              <button
                className="flex h-7 w-7 items-center justify-center rounded-full bg-gray-300 text-gray-800 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-200"
