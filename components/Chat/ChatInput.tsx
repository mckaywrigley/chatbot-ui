    ...
    return (
        <div
            ...
            <div
                ...
                <div
                    className="chat-textarea-display relative mx-2 flex w-full flex-grow flex-col rounded-md border border-black/10 bg-white shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:border-gray-900/50 dark:bg-[#40414F] dark:text-white dark:shadow-[0_0_15px_rgba(0,0,0,0.10)] sm:mx-4">
                    <button
            ...
            <div
                ...
                up {showScrollUpButton ? 'true' : 'false'} down {showScrollDownButton ? 'true' : 'false'}
                <a
