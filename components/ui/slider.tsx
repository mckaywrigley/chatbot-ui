...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="bg-pixelspace-gray-50 relative h-2 w-full grow overflow-hidden rounded-full">
      <SliderPrimitive.Range className="bg-pixelspace-pink absolute h-full" />
