...
export const TextareaAutosize: FC<TextareaAutosizeProps> = ({
  ...
  return (
    <ReactTextareaAutosize
      ref={textareaRef}
      className={cn(
        "bg-pixelspace-gray-60 placeholder:text-muted-foreground  flex resize-none rounded-md  text-sm focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      minRows={minRows}
