...
export const TextareaAutosize: FC<TextareaAutosizeProps> = ({
  ...
  return (
    <ReactTextareaAutosize
      ref={textareaRef}
      className={cn(
        "bg-pixelspace-pink placeholder:text-muted-foreground  flex resize-none rounded-md border-2 text-sm focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      minRows={minRows}
