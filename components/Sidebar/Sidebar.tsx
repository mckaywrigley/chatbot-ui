  ...
  return (
    ...
    >
      <header className="flex items-center">
        <button
          className="flex w-[190px] flex-shrink-0 cursor-pointer items-center gap-3 rounded-md border border-white/20 p-3 text-[12px] leading-[18px] text-white transition-colors duration-200 select-none hover:bg-gray-500/10"
          onClick={() => {
            onNewConversation();
            setSearchTerm('');
          }}
        ...
        <button
          className="ml-2 flex flex-shrink-0 cursor-pointer items-center gap-3 rounded-md border border-white/20 p-3 text-[12px] leading-[18px] text-white transition-colors duration-200 hover:bg-gray-500/10"
      ...
      <div className="flex-grow overflow-auto">
        ...
        {conversations.length > 0 ? (
          ...
          <div className="mt-8 text-white text-center opacity-50 select-none">
            ...
            <span className='text-[12px] leading-[18px]'>{t('No conversations.')}</span>
          </div>
        )}
      </div>
