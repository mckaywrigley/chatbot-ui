...
AS $$
DECLARE
  project_url TEXT := 'https://ymgejzylojglqeckdvxc.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InltZ2Vqenlsb2pnbHFlY2tkdnhjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTEwNTc4NCwiZXhwIjoyMDIwNjgxNzg0fQ.P6WRHUStHPvsNXCXo1-K_oS3Msr_O-U_b5wE6mcyrls'; -- full access needed for http request to storage
