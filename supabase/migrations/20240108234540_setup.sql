...
AS $$
DECLARE
  project_url TEXT := 'smvomdndfltqhtgzvxpw.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNtdm9tZG5kZmx0cWh0Z3p2eHB3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMjQyODYxOSwiZXhwIjoyMDI4MDA0NjE5fQ.Z13a_YJPX_rmbdXt8Lh-0G9R8zX5u_m33yOcP8jdknE'; -- full access needed for http request to storage
