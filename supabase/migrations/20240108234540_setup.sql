...
AS $$
DECLARE
  project_url TEXT := 'https://ciclxprufcqeiylbgpgi.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNpY2x4cHJ1ZmNxZWl5bGJncGdpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwOTAyNzgxNywiZXhwIjoyMDI0NjAzODE3fQ.hjz2f8ca78Vl4vm86znw1fwb2zy1fI0Zs6TC-P-1_Pk'; -- full access needed for http request to storage
