...
AS $$
DECLARE
  project_url TEXT := 'https://cktizxwhyecinjgllbqj.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNrdGl6eHdoeWVjaW5qZ2xsYnFqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwOTk3ODE2MywiZXhwIjoyMDI1NTU0MTYzfQ.--LZueClP0Zwj5DZZw8mRyTEp6ITWLZzzJrx1M8fSUE'; -- full access needed for http request to storage
