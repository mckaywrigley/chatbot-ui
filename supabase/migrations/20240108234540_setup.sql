...
AS $$
DECLARE
  project_url TEXT := 'https://uoggjoeovkvjpwyvjcsi.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVvZ2dqb2Vvdmt2anB3eXZqY3NpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwODA0MjUxNSwiZXhwIjoyMDIzNjE4NTE1fQ.hMSgO9ZUv0qE3piIrpmYCpeufJG3vr_ppNQjZEP9ZbU';
BEGIN
  SELECT
      INTO status, content
