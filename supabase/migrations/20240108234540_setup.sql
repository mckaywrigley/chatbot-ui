...
AS $$
DECLARE
  project_url TEXT := 'https://izapqklwlnizxzdosukq.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml6YXBxa2x3bG5penh6ZG9zdWtxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTExMzk5OCwiZXhwIjoyMDIwNjg5OTk4fQ.gEU6uX6ymsR0Zc9Z-LTEVUSO4Kk8NsVkQNXGU57acr0'; -- full access needed for http request to storage
