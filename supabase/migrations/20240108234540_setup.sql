...
AS $$
DECLARE
  project_url TEXT := 'https://ubxcnzfcflpmduqlovkx.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVieGNuemZjZmxwbWR1cWxvdmt4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNjk3MTA1NCwiZXhwIjoyMDIyNTQ3MDU0fQ.NKZGiaIyxhdjEv9iScWceuOaFAmg-Yde0VQMMNBs27A'; -- full access needed for http request to storage
