...
export const collectMessagesFromNode = (conversation: Conversation, startNodeId: string): ChatNode[] => {
...
export const collectMessagesFromTail = (conversation: Conversation): ChatNode[] => {
    const messageList: ChatNode[] = []
...
export const switchNode = (
    ...
    return {
        ...
        current_node: nextChildId? currentMessageList[currentMessageList.length - 1].id :conversation.current_node
    }
}
