...
import SubscriptionStep from "../../../components/setup/subscription-step"
import { createCustomerSession } from "../../../data/user/organizations"
import {
  SETUP_STEP_COUNT,
  StepContainer
  ...
  useEffect(() => {
    ;(async () => {
      ...
      if (!session) {
        ...
        const stripesession = await createCustomerSession(user.email || "")
        setProfile(profile)
